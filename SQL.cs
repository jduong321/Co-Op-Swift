...
where ProjectSprints.Proj_ID = {0}
    ...
    static public string getStoryDesc(string name)
    {
    ...
    static public string getUserPosition(int pid)
    {
      ...
      return position;
        ...
        //assign task to ppl
        static public void ExecuteAssignTask(int userid, String task, String proj)
        {
            SqlConnection db = null;
            ...
            try
            {
              ...
              String sql = string.Format(@"Update TaskTable  
                                  Set UID = '{0}'
                                  FROM TaskTable 
                                  where TaskTable.PID = '{1}'
                                  and
                                  TaskTable.TaskName = '{2}' ",
                userid, SQL.getProjectID(proj), task //and ProjectMembers.Proj_ID ='{2}'
                //username,SQL.getProjectID(proj)
                                                             );
